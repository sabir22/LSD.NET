...
/** LSD Simple Interface with Scale
    ...
    @return            A double array of size 7 x n_out, containing the list
                       ...
                       'out[7*n+0]' to 'out[7*n+6]'.
 */
extern __declspec(dllexport) double * lsd_scale(int * n_out, double * img, int X, int Y, double scale);
...
/** LSD Simple Interface
    ...
    @return            A double array of size 7 x n_out, containing the list
                       ...
                       'out[7*n+0]' to 'out[7*n+6]'.
 */
extern __declspec(dllexport) double * lsd(int * n_out, double * img, int imgSize, int X, int Y);
